                    ...
                    {features.map((feature, featureIndex) => (
                      ...
                      >
                        <h3>
                          <Tab
                            className={
                              "font-display text-sm sm:text-lg text-blue-100 hover:text-white lg:text-white"
                            }
                          >
                        ...
                        <p
                          className={
                            "mt-2  font-medium text-sm md:text-xl lg:text-2xl lg:block text-blue-50 group-hover:text-white"
                          }
                        >
                          {feature.value}
                        </p>
                      ...
                      <div className="w-full flex justify-center bg-slate-50  py-16 2xl:px-36 px-8 lg:ml-0 2xl:-ml-16  xl:10">
                        <div className="text-zinc-700 text-lg max-w-screen-lg ">
                          ...
                          <p className="mb-5">
                            ...
                            capturing the true diversity of India’s spoken
                          ...
                          <p className="mb-5">
                            ...
                            open-sourced. The current version of the data is
                            open-sourced here. Going forward, we hope to open
                            source through platforms like Bhashini (under the
                            National Language Translation Mission, MeiTY).
                          </p>
                          <p className="mb-5">
                            This will boost the development of technologies such
                            as automatic speech recognition (ASR), speech to
                            speech translation (SST), and natural language
                            understanding (NLU) that reflect the ground
